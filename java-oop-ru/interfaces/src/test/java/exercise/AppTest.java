...
class AppTest {
    ...
    @Test
     void testReversedSequence() {
        CharSequence result = new ReversedSequence("abcdef");
    ...
    void testReversedSequenceCharAt() {
        CharSequence result = new ReversedSequence("abcdef");
        char expected = 'e';
        assertThat(result.charAt(1)).isEqualTo(expected);
    }
    @Test
    void testReversedSequenceSubsequence() {
        CharSequence result = new ReversedSequence("abcdef");
        String expected = "edc";
        assertThat(result.subSequence(1, 4).toString()).isEqualTo(expected);
    }
    // END
}
