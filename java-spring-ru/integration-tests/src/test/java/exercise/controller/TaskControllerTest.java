...
class ApplicationTest {
    ...
    public void testUpdate() throws Exception {
        ...
        var expected = taskRepository.findByTitle(title).get().getId();
    ...
    public void testDelete() throws Exception {
        var task = generateTask();
        String id = String.valueOf(taskRepository.save(task).getId());
        ...
        assertThat(taskRepository.findById(Long.valueOf(id))).isNotPresent();

        var body = result.getResponse().getContentAsString();
        assertThat(body).doesNotContain(task.getTitle());
        assertThat(body).doesNotContain(task.getDescription());
    }
    // END
}
